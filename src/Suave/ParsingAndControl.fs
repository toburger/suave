...
module internal ParsingAndControl =
  ...
  let httpLoop (ctxOuter : HttpContext) (consumer : WebPart) =
    ...
    let facade = new ConnectionFacade(ctxOuter,ctxOuter.connection.transport,ctxOuter.connection.bufferManager,ctxOuter.connection.lineBuffer,runtime.logger,ctxOuter.request.trace,ctxOuter.runtime.matchedBinding)
